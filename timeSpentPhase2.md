...
- 9/4 8:04 am Planning the week and getting the csv file saving on G4-Brems. UPDATE: I got analysis working!!! thanks to some help from B4a. Next steps are: learning how to use the root viewer, and possibly switching it up so I get the histograms booked from eventaction instead of the hitscollection. 
