...
- 6/8 11:39 pm  researching LINAC's and how much activity they might have at a distance, I found out some info. First, it seems like they don't really measure activity of these beams, they skip right to measuring exposure aka dose. To end off today I'm going to look into Gant4, it seems like a super powerful C++ library we could use for modeling an x-ray beam
